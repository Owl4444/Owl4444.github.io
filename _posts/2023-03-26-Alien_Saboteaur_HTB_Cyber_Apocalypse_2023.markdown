---
layout: post
title: Alien Saboteaur - HTB Cyber Apocalyse 2023
description: A quick writeup on a Virtual Machine Based CTF Challenge.
date: 2023-03-26 02:45:00 +0800
image:  '/images/alien-saboteaur/backgroundimage.png'
tags:   [Writeups, CTF]
---
...
![image_description.png](/images/alien-saboteaur/image_description.png)
...
![vm_functions.png](/images/alien-saboteaur/function_present.png)
...
2.	A VM Context is created via `vm_create` which contains:
	...
	c.	Stack Pointer
	d.	Program Counter
![vm_create.png](/images/alien-saboteaur/vm_create.png)
...
![function_table.png](/images/alien-saboteaur/function_table.png)
...
![first_byte_offset_3.png](/images/alien-saboteaur/first_byte_offset_3.png)
	 
	b.	Example 1 :  {10 4D 00 00 00 00}
		i.	Opcode 0x10 maps to `vm_putc` which prints a character in the console. The next byte indicates the ASCII character `M` to print out.
	c.	Example 2  :   {0A 0f 00 00 00 00}
		i.	Opcode 0x0A maps to `vm_push`. The next byte refers to the register whose value would be pushed onto the stack.

![example2.png](/images/alien-saboteaur/example2.png)
...
![pattern_bin_file.png](/images/alien-saboteaur/pattern_bin_file.png)
...
![disassembler_vm_push.png](/images/alien-saboteaur/disassembler_vm_push.png)

The following shows an example disassembly for this instruction.
 

![disassembly_push.png](/images/alien-saboteaur/disassembly_push.png)
...
![disassembler_vm_je.png](/images/alien-saboteaur/disassembler_vm_je.png)

The output is as follows:

![disassembler_output_je.png](/images/alien-saboteaur/disassembler_output_je.png)
...
![disassembler_vm_inv.png](/images/alien-saboteaur/disassembler_vm_inv.png)

And finally, the example output from the bin file:

![disassembler_output_inv.png](/images/alien-saboteaur/disassembler_output_inv.png)
...
![encrypted_keycode.png](/images/alien-saboteaur/encrypted_keycode.png)
...
![keycode_script.png](/images/alien-saboteaur/keycode_script.png)
...
![working_keycode.png](/images/alien-saboteaur/working_keycode.png)
...
![anti-debug.png](/images/alien-saboteaur/anti-debug.png)
...
![anti-debug-pseudocode.png](/images/alien-saboteaur/anti-debug-pseudocode.png)
...
![patched_disassembly.png](/images/alien-saboteaur/patched_disassembly.png)

The patched bin file should successfully bypass the anti-debugging feature.

![success_bypass.png](/images/alien-saboteaur/success_bypass.png)
...
![idisassembly1_encrypted_instruction.png](/images/alien-saboteaur/disassembly1_encrypted_instruction.png)
...
![encrypted_instruction_data.png](/images/alien-saboteaur/encrypted_instruction_data.png)
...
![prompt_secret_phrase_found.png](/images/alien-saboteaur/prompt_secret_phrase_found.png)
...
![disassembly_algo1.png](/images/alien-saboteaur/disassembly_algo1.png)

![disassembly_algo2.png](/images/alien-saboteaur/disassembly_algo2.png)
...
![flagged.png](/images/alien-saboteaur/flagged.png)
