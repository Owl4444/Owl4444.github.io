---
layout: post
title: Understanding 64 bits Windows 10 Shellcode (Calc.exe) - Part 1
description: In this part, we will see how basic shellcode works and how we move from the TEB structure to getting Kernel32.dll base address to getting WinExec's function pointer and popping calculator.
image: '/images/windows10shellcodePart1/Windows10Shellcodepart1.png'
date: 2022-09-08 05:12:00 +0800
tags: [Writeups]
---
...
![PEB_to_entry.png](/images/windows10shellcodePart1/PEB_to_entry.png)
...
![teb_structure.png](/images/windows10shellcodePart1/teb_structure.png)
...
![peb_structure.png](/images/windows10shellcodePart1/peb_structure.png)
...
![peb_ldr_data.png](/images/windows10shellcodePart1/peb_ldr_data.png)
...
![LDR_DATA_TABLE_ENTRY.png](/images/windows10shellcodePart1/LDR_DATA_TABLE_ENTRY.png)
...
![dlr data table populated](/images/windows10shellcodePart1/LDR_DATA_TABLE_ENTRY2.png)
...
![loaded_kernel32_info.png](/images/windows10shellcodePart1/loaded_kernel32_info.png)

Now that we have the DllBase address, we can deal with Kernel32.dll as a PE File as well. Here we can see the MZ Signature.

![kernel32dllPE.png](/images/windows10shellcodePart1/kernel32dllPE.png)


### Locating the Export Table

![diagramexporttable.png](/images/windows10shellcodePart1/diagramexporttable.png)
...
![newexeheader.png](/images/windows10shellcodePart1/newexeheader.png)
...
![section_headers.png](/images/windows10shellcodePart1/section_headers.png)

Now, if we check the exports tab, we should see 0x980a0 being the offset. 
![kernel32dllexporttable.png](/images/windows10shellcodePart1/kernel32dllexporttable.png)
...
![diagram_shellcode_end.png](/images/windows10shellcodePart1/diagram_shellcode_end.png)
...
![exporttable.png](/images/windows10shellcodePart1/exporttable.png)
...
![FunctionNameTable.png](/images/windows10shellcodePart1/FunctionNameTable.png)
*Function Name Table*
...
![ordinal_to_functionaddress.png](/images/windows10shellcodePart1/ordinal_to_functionaddress.png)
...
![Windows_Shellcoding_flow_dark.png](/images/windows10shellcodePart1/Windows_Shellcoding_flow_dark.png)
*Windows Shellcoding x64 Illustration- Calc.exe*

In the second part of the understand Windwows Shellcode, we will be writing the Shellcode using this flow diagram. Hopefully, this will be useful for the readers.
