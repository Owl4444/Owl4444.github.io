---
layout: post
title: Quick Study of Bring Your Own Vulnerable Driver (BYOVD)
description: Quick Study of BYOVD including Root Cause Analysis and how it can be abused by attackers to disable or evade security solutions.
date: 2023-06-13 09:27:00 +0800
image:  '/images/quickstudyBYOVD/backgroundimage.png'
tags:   [QuickPeek, Writeups]
---
...
![/images/quickstudyBYOVD//IOCTL_TERMINATE_PROCESS.png](/images/quickstudyBYOVD//IOCTL_TERMINATE_PROCESS.png)
...
![handle.png](/images/quickstudyBYOVD//handle.png)

We can see the SymbolicLink for `ZemanaAntiMalware`. We can get more information about it with `!object <handle address>`.

![handleobjectdetails.png](/images/quickstudyBYOVD//handleobjectdetails.png)
...
![/images/quickstudyBYOVD//check_control_code_terminate_process.png](/images/quickstudyBYOVD//check_control_code_terminate_process.png)
...
![IOCTL_TERMINATE_PROCESS_RECEIVED.png](/images/quickstudyBYOVD//IOCTL_TERMINATE_PROCESS_RECEIVED.png)

Next thing to verify is to check if the block for terminating process has been reached.
```
bu Terminator+0x10B14
```
![check_if_terminate_reached.png](/images/quickstudyBYOVD//check_if_terminate_reached.png)
...
![/images/quickstudyBYOVD//Check_if_pid_registered_sub140009bec.png](/images/quickstudyBYOVD//Check_if_pid_registered_sub140009bec.png)
...
![IOCTL_REGISTER_PROCESS.png](/images/quickstudyBYOVD//IOCTL_REGISTER_PROCESS.png)

Checking the conditions above again, we can see that this control code is exempted from the checks.

![/images/quickstudyBYOVD//IOCTL_REGISTER_PROCESS_EXEMPTED.png](/images/quickstudyBYOVD//IOCTL_REGISTER_PROCESS_EXEMPTED.png)
...
![registeredcode.png](/images/quickstudyBYOVD//registeredcode.png)
...
![process_kill.png](/images/quickstudyBYOVD//process_kill.png)
...
![/images/quickstudyBYOVD//blacklistprocesses.png](/images/quickstudyBYOVD//blacklistprocesses.png)
