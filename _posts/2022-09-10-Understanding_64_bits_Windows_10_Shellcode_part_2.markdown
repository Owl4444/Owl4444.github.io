---
layout: post
title: Understanding 64 bits Windows 10 Shellcode (Calc.exe) - Part 2
description: Now that we have an understanding about how shellcode works, let's write one ourselves now @.@
image: '/images/windows10shellcodePart2/Windows10Shellcodepart2.png'
date: 2022-09-10 06:31:00 +0800
tags: [Writeups]
---
...
Welcome back to the second part of understanding 64 bits Windows 10 shellcode. In Part 1, we have taken a look at we can get function address from any loaded modules. In this case, we were targetting the function `WinExec` to execute commands, and we wanted to spawn calc.exe for this shellcode.

In this post, we will write our own shellcode following closely to what was described in the previous part. I am using the Miscrosoft Visual Studio's Macro Assembler. Let's dive straight in. 
...
![CreateNewEmptyProject.png](/images/windows10shellcodePart2/CreateNewEmptyProject.png)
...
Right click on the project root folder (Not the solution) and select `Build Dependencies`, then click on `Build Customizations...`. The Visual C++Build Cusomizations File Window should open. We will need to click on `masm` checkbox to enable building with masm.


![build_customizations.png](/images/windows10shellcodePart2/build_customizations.png)

Next, right click on our shellcode.asm file and click on properties. We will wnat to set the `Item Type` to Microsoft Macro Assembler.

![asm_config.png](/images/windows10shellcodePart2/asm_config.png)
...
![Windows_Shellcoding_flow_dark.png](/images/windows10shellcodePart2/Windows_Shellcoding_flow_dark.png)
...
![winexec_correctargs.png](/images/windows10shellcodePart2/winexec_correctargs.png)

To verify that register rdi is indeed WinExec, let's check from WinDBG :

![winexec_correctfunction.png](/images/windows10shellcodePart2/winexec_correctfunction.png)
...
![destroyingstack.png](/images/windows10shellcodePart2/destroyingstack.png)
...
![calc.png](/images/windows10shellcodePart2/calc.png)
