...
- [[#^d26e06|IA32_EFER.SCE/SYSCALL Enable flag]] is not set  OR  [[#^11f1ef|IA32_EFER.LMA/IA-32 mode is active]] is not set or `CS.L` (Not in 64 bits) , then its undefined operation.
